...
int rightMotorPin1=18;  //16
int rightMotorPin2=19;     //17
//Left motor
int enableLeftMotor=22;
int leftMotorPin1=4; //18
int leftMotorPin2=2;
...
void notify()
{
  ...
  rightMotorSpeed = constrain(rightMotorSpeed, -255, 255); // low to high 
  leftMotorSpeed = constrain(leftMotorSpeed, -255, 255); // low to high
